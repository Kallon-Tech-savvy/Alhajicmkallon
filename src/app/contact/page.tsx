            ...
            <div className="glass-frost p-8 md:p-12 rounded-sm shadow-2xl">
              {status !== 'success' ? (
                <form onSubmit={handleSubmit} className="space-y-8">
                  <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-5 text-sm text-muted">
                    <p className="font-space text-[10px] uppercase tracking-[0.3em] text-pride-blue mb-2">How to prepare your message</p>
                    <p className="leading-relaxed">
                      Start with a brief summary of your initiative, the problem you want solved, and the audience you are serving. Add any timing expectations and the desired outcome so Alhaji can respond with the most relevant next step.
                    </p>
                  </div>
