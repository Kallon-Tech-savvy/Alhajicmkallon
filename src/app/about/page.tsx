...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-midnight text-ivory overflow-x-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            <p>
              ...
              and designing solutions that create meaningful impact. What began as a passion has grown into a broader 
              mission.
            </p>
            <p>
      ...
      <Footer
        ctaHeading="Like the way this sounds?"
        ctaBody="If this approach to design and engineering fits what you're building, let's talk about it."
      />
    </main>
  );
}