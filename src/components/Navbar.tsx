          ...
          >
            ...
            >
              ...
              <div className="flex gap-8 font-[family-name:var(--font-jetbrains-mono)] text-xs uppercase tracking-widest"
                   style={{ color: '#6B7280' }}>
                <a href={getSocialHref('twitter')} target="_blank" rel="noopener noreferrer"
                   className="hover:text-[#006BFF] transition-colors">Twitter</a>
                <a href={getSocialHref('linkedin')} target="_blank" rel="noopener noreferrer"
                   className="hover:text-[#006BFF] transition-colors">LinkedIn</a>
                <a href={getSocialHref('github')} target="_blank" rel="noopener noreferrer"
